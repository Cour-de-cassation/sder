...
describe('convertOccultationBlockInCategoriesToOmit', function () {
    it('should return categories for block 1', function () {
        var categoriesToOmit = convertOccultationBlockToCategoriesToOmit_1.convertOccultationBlockInCategoriesToOmit(1);
        expect(categoriesToOmit.sort()).toEqual(['professionnelMagistratGreffier'].sort());
    });
    it('should return categories for block 2', function () {
        var categoriesToOmit = convertOccultationBlockToCategoriesToOmit_1.convertOccultationBlockInCategoriesToOmit(2);
    ...
    it('should return categories for block 3', function () {
        var categoriesToOmit = convertOccultationBlockToCategoriesToOmit_1.convertOccultationBlockInCategoriesToOmit(3);
    ...
    it('should return categories for block 4', function () {
        var categoriesToOmit = convertOccultationBlockToCategoriesToOmit_1.convertOccultationBlockInCategoriesToOmit(4);
    ...
    it('should return categories for block null', function () {
        var categoriesToOmit = convertOccultationBlockToCategoriesToOmit_1.convertOccultationBlockInCategoriesToOmit(undefined);
        expect(categoriesToOmit.sort()).toEqual(['professionnelMagistratGreffier', 'personneMorale', 'numeroSiretSiren'].sort());
    });
});
