...
exports.cleanXml = void 0;
function cleanXml(xml) {
    // <TEXTE_ARRET> splitting and removing:
    var fragments = xml.split(/<\/?texte_arret>/gi);
    ...
    var textNextToCatPub = xml.indexOf('</CAT_PUB><TEXTE_ARRET>') !== -1;
    ...
    if (textNextToCatPub === true) {
        ...
        throw new Error('JurinetUtils.CleanXML: End of <CAT_PUB> tag not found: the document could be malformed or corrupted.');
    }
    return xml;
}
