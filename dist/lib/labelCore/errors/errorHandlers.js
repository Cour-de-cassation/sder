...
var errorHandlers = {
    authenticationErrorHandler: buildErrorHandler(utils_1.httpStatusCodeHandler.HTTP_STATUS_CODE.ERROR.AUTHENTICATION_ERROR),
    permissionErrorHandler: buildErrorHandler(utils_1.httpStatusCodeHandler.HTTP_STATUS_CODE.ERROR.PERMISSION_ERROR),
    notFoundErrorHandler: buildErrorHandler(utils_1.httpStatusCodeHandler.HTTP_STATUS_CODE.ERROR.NOT_FOUND_ERROR),
    serverErrorHandler: buildErrorHandler(utils_1.httpStatusCodeHandler.HTTP_STATUS_CODE.ERROR.SERVER_ERROR),
};
...
function throwFromStatusCode(statusCode) {
    ...
    if (utils_1.httpStatusCodeHandler.isError(statusCode)) {
