...
function buildRawJuricaRepository() {
    return __awaiter(this, void 0, void 0, function () {
        var runMongo;
        return __generator(this, function (_a) {
            runMongo = utils_1.buildRunMongo(rawJuricaCollectionName_1.rawJuricaCollectionName);
            return [2 /*return*/, {
                    clear: function () {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 1:
                                                        result = _b.sent();
                                                        if (!result) {
                                                            throw new Error("No matching " + rawJuricaCollectionName_1.rawJuricaCollectionName + " for _id " + id);
                                                        }
...
exports.buildRawJuricaRepository = buildRawJuricaRepository;
