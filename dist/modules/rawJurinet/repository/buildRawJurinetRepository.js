...
function buildRawJurinetRepository() {
    return __awaiter(this, void 0, void 0, function () {
        var runMongo;
        return __generator(this, function (_a) {
            runMongo = utils_1.buildRunMongo(rawJurinetCollectionName_1.rawJurinetCollectionName);
            return [2 /*return*/, {
                    clear: function () {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                            ...
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 1:
                                                        result = _b.sent();
                                                        if (!result) {
                                                            throw new Error("No matching " + rawJurinetCollectionName_1.rawJurinetCollectionName + " for _id " + id);
                                                        }
...
exports.buildRawJurinetRepository = buildRawJurinetRepository;
