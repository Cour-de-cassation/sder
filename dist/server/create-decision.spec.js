...
describe('/create-decision', function () {
    it('should create a new decision in the database with the given field', function () { return __awaiter(void 0, void 0, void 0, function () {
        var decisionRepository, decisionField, response, createdDecishion;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, modules_1.decisionModule.buildRepository()];
                case 1:
                    decisionRepository = _a.sent();
                    decisionField = lodash_1.omit(modules_1.decisionModule.lib.generateDecision(), [
                        '_id',
                        '_rev',
                        'labelStatus',
                        'labelTreatments',
                    ]);
                    return [4 /*yield*/, request.post("/create-decision").send(decisionField)];
                case 2:
                    response = _a.sent();
                    return [4 /*yield*/, decisionRepository.findByDecisionId(decisionField.sourceId)];
                case 3:
                    createdDecishion = _a.sent();
                    expect(response.status).toEqual(200);
                    expect(lodash_1.omit(createdDecishion, ['_id', '_rev', 'labelStatus', 'labelTreatments'])).toEqual(decisionField);
                    return [2 /*return*/];
            }
        });
    }); });
