...
describe('/pseudonymisation-to-export', function () {
    it('should return all the pseudonymisation text and id of the decisions ready to be exported', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, request.get("/pseudonymisation-to-export")];
                case 3:
                    response = _a.sent();
