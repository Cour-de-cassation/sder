...
function buildRunMongo(collectionName) {
    ...
    return function (command) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("[sder lib] Connecting to MongoDb: ".concat(environment.SDER_DB_URL, " ").concat(environment.SDER_DB_NAME));
                    return [4 /*yield*/, new mongodb_1.MongoClient(environment.SDER_DB_URL).connect()];
                case 1:
                    client = _a.sent();
